...
class Fotter extends Component {
    ...
    render() {
        ...
        return (
            <React.Fragment>
                <div style={{ backgroundImage: "url(" + footerbg + ")", backgroundColor: "#222224", color: "#fff" }}>
                    <Container maxWidth="lg">
                        <Grid container >
                        <Grid item xs={12} sm={12} md={3} lg={3}>
                                <Typography style={{ marginTop: "20px" }} variant="subtitle2" >FREQUENTLY ASKED QUESTIONS</Typography>
                            ...
                            <Grid item xs={12} sm={12} md={3} lg={3}>
                                <Typography style={{ marginTop: "20px" }} variant="subtitle2" >SOCIAL MEDIA</Typography>
                                <List component="nav" aria-label="secondary mailbox folders">
                                    <ListItem className="list">
                            ...
                            <Grid  item xs={12} sm={12} md={3} lg={3}>
                                <Typography style={{ marginTop: "20px" }} variant="subtitle2" >CONTACT US</Typography>
                                <div className="address">
                                    <Typography variant="body2" >
                                        TRESOR JEWEL  <br/>42 West 48th Street,<br />Suite #303 New York,<br />NY-10036
                                 </Typography>
                                </div>
                               <div className="footer-div">
                               <Typography className="address" style={{align:'left'}} variant="body2" >
